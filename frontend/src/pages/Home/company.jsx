            ...
            <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
                <div className="relative sm:py-16 lg:py-0">
                    ...
                    <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                        {/* Testimonial card*/}
                        <div className="relative pt-33 pb-10 rounded-2xl shadow-xl overflow-hidden">
                            <img
                ...
                <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
                    ...
                    <div className="pt-12 sm:pt-16 lg:pt-20">
                        ...
                        <div className="mt-6 text-gray-500 space-y-6">
                            <p className="text-lg">
                            Welcome to our advanced fleet management web app, where efficiency meets simplicity. With our powerful platform, managing your vehicle fleet has never been easier. Streamline your operations, optimize performance, and stay in control of your fleet's every move. Say goodbye to complex spreadsheets and manual tracking, and say hello to a seamless fleet management experience. Unlock the full potential of your fleet with our comprehensive suite of features and tools. Welcome to a new era of efficient and hassle-free fleet management.
                            </p>
